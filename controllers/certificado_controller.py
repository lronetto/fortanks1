...
def index():
    ...
    return render_template('certificados/index.html', certificados=certificados, hoje=hoje, tipos=tipos)
...
def tipos_index():
    ...
    """
    tipos = CertificadosTipos.query.filter_by(ativo=True).order_by(CertificadosTipos.nome).all()
    return render_template('certificados/tipos_index.html', tipos=tipos)
