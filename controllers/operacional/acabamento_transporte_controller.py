...
def index():
    ...
    tanque_id = filtros.get('tanque_id', 'todos')
    return render_template('operacional/acabamento_transporte/index.html',
                           tanques=tanques,
...
def acabamento():
    ...
    return render_template('operacional/acabamento_transporte/modais/acabamento.html', 
                           tanques=tanques, 
...
def transporte():
    ...
    tanques = Tanques.query.order_by(Tanques.nome).all()
    csrf_token = generate_csrf()
    return render_template('operacional/acabamento_transporte/modais/transporte.html', 
                           tanques=tanques, 
                           csrf_token=csrf_token,
                           now=datetime.now().strftime('%Y-%m-%d'))
