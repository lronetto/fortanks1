...
def index():
    ...
    return render_template('planos_conta/index.html', 
...
def novo():
    ...
    if request.method == 'POST':
        ...
        if not codigo or not descricao:
            ...
            return render_template('planos_conta/novo.html')
...
def visualizar(id):
    ...
    return render_template('planos_conta/visualizar.html', plano_conta=plano_conta)
...
def editar(id):
    ...
    if request.method == 'POST':
        ...
        if not codigo or not descricao:
            flash('Todos os campos obrigatórios devem ser preenchidos!', 'danger')
            return render_template('planos_conta/editar.html', 
...
def importar():
    ...
    if request.method == 'POST':
        ...
        if 'arquivo_excel' not in request.files:
            ...
            return render_template('planos_conta/importar.html')
    ...
    return render_template('planos_conta/importar.html', resultados=resultados) 