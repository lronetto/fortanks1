...
def index():
    ...
    try:
        ...
        return render_template('materiais/grupos/index.html', grupos=None)
...
def detalhes(id):
    ...
    try:
        ...
        return render_template('materiais/grupos/detalhes.html', grupo=grupo)
...
def materiais(id):
    ...
    try:
        ...
        return render_template('materiais/grupos/materiais.html', 
                             grupo=grupo, 
                             materiais=materiais, 
                             search=search)
