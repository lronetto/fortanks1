...
def index():
    ...
    return render_template('admin/cadastros/cargos/index.html', cargos=cargos)
...
def novo():
    ...
    if request.method == 'POST':
        ...
        if not nome:
            ...
            return render_template('admin/cadastros/cargos/novo.html')
...
def editar(id):
    ...
    if request.method == 'POST':
        ...
        if not nome:
            flash('Por favor, informe o nome do cargo.', 'danger')
            return render_template('admin/cadastros/cargos/editar.html', cargo=cargo)
...
def visualizar(id):
    ...
    """
    cargo = Cargo.query.get_or_404(id)
    return render_template('admin/cadastros/cargos/visualizar.html', cargo=cargo) 