...
def index():
    ...
    try:
        return render_template('admin/cadastros/unidades/index.html')
    ...
    if request.method == 'POST':
        try:
            ...
            if not nome:
                ...
                return render_template('admin/cadastros/unidades/form.html')
...
def editar(id):
    ...
    if request.method == 'POST':
        try:
            ...
            if not nome:
                flash("O nome da unidade é obrigatório", "warning")
                return render_template('admin/cadastros/unidades/form.html', unidade=unidade)
