...
def index():
    ...
    return render_template('admin/cadastros/centro_custo/index.html', centros_custo=centros_custo)
...
def novo():
    ...
    if request.method == 'POST':
        ...
        if not codigo or not nome:
            ...
            return render_template('admin/cadastros/centro_custo/novo.html')
...
def editar(id):
    ...
    if request.method == 'POST':
        ...
        if not codigo or not nome:
            flash('Por favor, preencha todos os campos obrigatórios.', 'danger')
            return render_template('admin/cadastros/centro_custo/editar.html', centro_custo=centro_custo)
