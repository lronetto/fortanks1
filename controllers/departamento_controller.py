    ...
    try:
        ...
        for dep in departamentos:
            ...
            acoes = (
                ...
                f'  <button type="button" class="btn btn-sm btn-primary btn-editar" '
                ...
                f'  <button type="button" class="btn btn-sm btn-info btn-visualizar" '
                f'      data-id="{dep.id}" data-nome="{dep.nome}" '
                f'      data-descricao="{dep.descricao or "N/A"}" data-status="{dep.status}" '
                f'      data-status-badge=\'{badge}\' '
                f'      data-criado="{criado_em}" data-atualizado="{atualizado_em}" '
                f'      title="Visualizar"><i class="fas fa-eye"></i></button>'
                f'  <button type="button" class="btn btn-sm btn-danger btn-excluir" '
                f'      data-id="{dep.id}" data-nome="{dep.nome}" '
                f'      title="Excluir"><i class="fas fa-trash"></i></button>'
                f'</div>'
            )
