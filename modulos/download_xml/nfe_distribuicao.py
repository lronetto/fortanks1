...
class DocumentoXML:
    ...
    @property
    def emitido_pela_empresa(self) -> bool | None:
        """True se a empresa for emitente; precisa do CNPJ comparado externamente."""
        return None  # avaliado pelo orquestrador, que conhece o CNPJ-alvo
