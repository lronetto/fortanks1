...
Rotas relevantes para download de XMLs no período (manual v1.2):
  GET /NFSe?dEmiInicial=YYYY-MM-DD&dEmiFinal=YYYY-MM-DD&papel=...&inscricao=...
      -> lista de chaves de acesso
  GET /NFSe/{chaveAcesso}
      -> XML completo (gzip+base64)

`papel` aceita: PRESTADOR, TOMADOR, INTERMEDIARIO.
"""
...
def listar_chaves(
    ...
    *,
    ...
    # O manual descreve resposta como lista de objetos com chaveAcesso;
    # em algumas versões o atributo é chaveAcesso, em outras chave.
    chaves: List[str] = []
...
def baixar_xml(
    ...
    *,
    ...
    # Resposta documentada: XML compactado (gzip) e codificado em base64.
